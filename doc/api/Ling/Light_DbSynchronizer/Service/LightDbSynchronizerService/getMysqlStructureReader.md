...
LightDbSynchronizerService::getMysqlStructureReader
================



LightDbSynchronizerService::getMysqlStructureReader — Returns a MysqlStructureReader instance.
...
Returns [MysqlStructureReader](https://github.com/lingtalfi/SqlWizard/blob/master/doc/api/Ling/SqlWizard/Util/MysqlStructureReader.md).
...
Source Code
===========
See the source code for method [LightDbSynchronizerService::getMysqlStructureReader](https://github.com/lingtalfi/Light_DbSynchronizer/blob/master/Service/LightDbSynchronizerService.php#L855-L861)
