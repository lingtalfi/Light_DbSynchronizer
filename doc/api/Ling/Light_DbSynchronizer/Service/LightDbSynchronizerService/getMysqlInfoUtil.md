...
LightDbSynchronizerService::getMysqlInfoUtil
================



LightDbSynchronizerService::getMysqlInfoUtil — Returns a MysqlInfoUtil instance.
...
Source Code
===========
See the source code for method [LightDbSynchronizerService::getMysqlInfoUtil](https://github.com/lingtalfi/Light_DbSynchronizer/blob/master/Service/LightDbSynchronizerService.php#L910-L917)
...
Previous method: [getMysqlStructureReader](https://github.com/lingtalfi/Light_DbSynchronizer/blob/master/doc/api/Ling/Light_DbSynchronizer/Service/LightDbSynchronizerService/getMysqlStructureReader.md)<br>Next method: [getIndexDiff](https://github.com/lingtalfi/Light_DbSynchronizer/blob/master/doc/api/Ling/Light_DbSynchronizer/Service/LightDbSynchronizerService/getIndexDiff.md)<br>
